...
<html lang="en">
    ...
    <body>
        ...
        <?php if(isset($_GET["espansione1"])):
            ...
            $carta1 = $GLOBALS["conn"]->query("select * from carte where espansione = '$espansione1' and numero = $numero1")->fetch_assoc();
            $carta2 = $GLOBALS["conn"]->query("select * from carte where espansione = '$espansione2' and numero = $numero2")->fetch_assoc();
            ?>
            <div>
                <table>
                    <?php
                        ...
                        ?></tr><?php
                        if(compareElements($carta1, $carta2, true)){
                            ?><tr><?php
