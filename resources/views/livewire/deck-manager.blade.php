<div>
    ...
    <div x-data="{ showMessage: false, message: '', type: 'info' }" 
         ...
         x-show="showMessage"
         x-transition
         class="fixed bottom-4 right-4 p-4 border rounded-4 border-secondary border-5 shadow-lg text-center fs-3 position-absolute top-50 start-50 translate-middle"
