...
<html lang="it" class="<?php echo $file;?>">
    ...
    <?php
        ...
        function compareElements($el1, $el2) {
            ...
            $result = $conn->query("sSELECT COUNT(*) FROM (SELECT DISTINCT mazzo, codUtente, public FROM mazzi where codUtente = ".unserialize($_SESSION["user"])->getID()." or public = '1' order by mazzo) as m;");
