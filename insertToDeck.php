...
<html lang="it" class="<?php echo $file;?>">
    ...
    <body>
        <form action="insertTo">
            ...
            <br>
            <label for="numero">inserisci il numero della carta da inserire </label><input <?php if(isset($_GET["espansione"])){echo 'id="selected"';}?> type="number" name="numero" placeholder="numero" value="<?php echo $_GET["numero"];?>">
            <br>
