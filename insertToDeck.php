...
<html lang="it" class="<?php echo $file;?>">
    ...
    <body>
        <form action="insertTo">
            ...
            <br>
            <label for="espansione">inserisci il set della carta da inserire </label><input <?php if(isset($_GET["espansione"])){echo 'id="selected"';}?> list="espansioni" type="text" name="espansione" placeholder="set" value="<?php echo $_GET["espansione"];?>">
