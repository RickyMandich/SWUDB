...
return [
    ...
    | utilizzati dalla classe di convalida. Alcune di queste regole hanno
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Il campo :attribute è stato trovato in una violazione di dati. Scegli un altro :attribute.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | In questa sezione puoi specificare i messaggi di convalida personalizzati
    | per gli attributi utilizzando la convenzione "attribute.rule" per
    | denominare le righe. Questo rende veloce specificare una riga di lingua
    | personalizzata specifica per una data regola di attributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Le seguenti righe di lingua vengono utilizzate per sostituire il nostro segnaposto attributo
    | con qualcosa di più leggibile come "Indirizzo E-Mail" invece di "email". 
