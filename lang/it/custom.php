...
return[
    ...
    |
    */
    'welcome' => 'Benvenuto su '.config("app.domain", "SWUDB.net").'!',
    'upperFooter' => 
        config("app.domain", "SWUDB.net").' è un sito non ufficiale fatto dai fan. Le informazioni testuali e grafiche presenti sul sito relative a Star Wars: Unlimited, incluse immagini delle carte e simboli, hanno il copyright di Fantasy Flight Publishing Inc e Lucasfilm Ltd. '.config("app.domain", "SWUDB.net").' non è prodotto o approvato da FFG or LFL.',
    'lowerFooter' => 
        'Tutti gli altri contenuti © 2023 - 2025 '.config("app.domain", "SWUDB.net").". l'uso di questo sito costituisce l'accettazione dei termini di servizio di ".config("app.domain", "SWUDB.net").' Terms of Service.',
