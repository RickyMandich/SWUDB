...
Route::get('/mazzo/{user}/{mazzo}/build', [DecksController::class, 'build'])->name("mazzo.build")->middleware('auth');

Route::get('/mazzo/{user}/{mazzo}/build/export', [DecksController::class, 'exportBuildTxt'])->name("mazzo.build.export")->middleware('auth');
